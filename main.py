...
class PalindromeApp:
    def __init__(self, root):
        ...
        self.save_button = tk.Button(root, text="Save Word", command=self.save_word)
        self.save_button.pack(pady=5)
        self.export_button = tk.Button(root, text="Export Summary", command=self.export_session_summary)
        ...
        game_menu.add_command(label="Export Session Summary", command=self.export_session_summary)
